...
<div class="container gallery-container-Milolib">
    ...
    <div class="tz-gallery">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <a class="lightbox" href="Milolib/users-stories.png">
                        <img src="Milolib/users-stories.png" alt="Sample">
                    </a>
                    <div class="caption">
                        <h3>An example of Users Stories</h3>
                        <!-- <p>...</p> -->
                    </div>
                </div>
            </div>
